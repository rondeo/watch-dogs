...
export class SlackService {
  ...
  private url = 'https://slack.com/api/chat.postMessage?token=xoxp-280310993205-280093410915-280168420722-37803fd28649fd2e8421e60a20ec120a&channel={{channel}}&text={{message}}&pretty=1'
