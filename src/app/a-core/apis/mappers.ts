import {VOMarket, VOMarketCap} from '../../amodels/app-models';
...
export class Mappers {
  ...
  static etherdeltaMarkets(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                           bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
  ...
  static bitsaneMarkets(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                        bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
  ...
  static bithumbMarkets(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                        bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
  ...
  static coinoneMarkets(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                        bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
  ...
  static bitzMarkets(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                     bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
  ...
  static exmoMarkets(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                     bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
  ...
  static bitfinexCurencies(result: any, marketsAr: VOMarket[], indexed: {[pair: string]: VOMarket},
                           bases: string[],  marketCap: {[symbol: string]: VOMarketCap}) {
...
*/
  ...
  static bittrexMarkets(
    ...
    let ar1: SOMarketBittrex[] = result.result;
    let BASES = {};
    ...
    ar1.forEach(function (item: SOMarketBittrex) {
  ...
  static cryptopiaMarkets(
    ...
    let ar1: SOMarketCryptopia[] = result.Data;
    ar1.forEach(function (item: SOMarketCryptopia) {
  ...
  static livecoinMarkets( result: any, marketsAr: VOMarket[], indexed: { [p: string]: VOMarket },
                          baseCoins: string[], marketCap: { [p: string]: VOMarketCap }) {
// console.log(reports)
    let ar1: SOMarketLiveCoin[] = result;

    ar1.forEach(function (item: SOMarketLiveCoin) {
  ...
  static mapDisplayValues1(item: VOMarket, basePrice: number, base_1h: number, base_24h: number, base_7d: number, marketCap: any) {
    let base = basePrice;
 ...
 //   item.dVolume = (item.Volume/1e6).toFixed(3)+'M';
  ...
  static yobitCurencies(res: any, marketsAr: VOMarket[], indexed: { [p: string]: VOMarket }, baseCoins: string[], marketCap: { [p: string]
      : VOMarketCap }) {
    let obj = res.pairs;
